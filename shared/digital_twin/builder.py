...
class DigitalTwinBuilder:
    ...
    def build(cls, user_id: str) -> Dict[str, Any]:
        ...
        # Extract Raw Models & AI User Memories
        ...
        user_memories = UserMemory.objects.filter(user_id=user_id, is_active=True)
        memories_serialized = [
            {
        ...
        return {
            ...
            "projects": projects,
            "insights": insights,
            "user_memories": memories_serialized,
        }
...
# CareerAgent Canonical Naming Alias
CareerAgentBuilder = DigitalTwinBuilder
